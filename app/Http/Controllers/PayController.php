...
//            'return_url' => 'http://www.blog.com/api/order/pay',         // 同步通知 url，*强烈建议加上本参数*
            'return_url' => 'http://www.blog.com/api/pay/return',         // 同步通知 url，*强烈建议加上本参数*
            'notify_url' => 'http://mmjx5n.natappfree.cc/laravel/public/api/pay/notify',         // 异步通知 url，*强烈建议加上本参数*
        ],
    ];
    ...
    public function return(Request $request)
    {
        ...
        header("location:http://localhost:8080/#/shop_car3?order_id=$order_id&total_price=$total_price&order_time=$order_time");
    }
